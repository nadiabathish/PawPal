...
function SignUpForm() {
    ...
    // Event handler for the form submission
        ...
        try {
            ...
            formData.append('name', ownersName); // Sending the user's name as 'name'
            formData.append('dog_name', dogName);
            formData.append('dog_age', dogAge);
            formData.append('dog_breed', dogBreed);
            formData.append('play_styles', JSON.stringify(playStyles)); // Convert play_styles to JSON string
    
            // Append each selected image file to the FormData object
            for (let i = 0; i < image.length; i++) {
                formData.append('profile_pictures', image[i]);
            }
...
//                 profile_pictures: image // Sending the image file
//             });
